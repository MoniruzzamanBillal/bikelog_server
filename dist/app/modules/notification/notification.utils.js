...
exports.getLastCompletedWeekRange = void 0;
...
const getLastCompletedWeekRange = (now) => {
    ...
    const mostRecentFridayLocalMs = Date.UTC(localNow.getUTCFullYear(), localNow.getUTCMonth(), localNow.getUTCDate() - daysSinceFriday, 0, 0, 0, 0);
...
exports.getLastCompletedWeekRange = getLastCompletedWeekRange;
